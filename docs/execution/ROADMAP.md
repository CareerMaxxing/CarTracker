...
| 5 | Parts Domain | Parts as first-class entities: part number, manufacturer, description, category, fitment, purchases, suppliers, price history, documents. Price belongs to a purchase, not the part. | 🟡 Backend + API done and verified via curl (PHASE_05.md); UI is a follow-up increment |

...
- Phase 16 (Sidebar App Shell & Dashboard Redesign): user shared a dashboard mockup and asked to plan
  ...
  in this phase. **Next: user visual review of Vehicle/Index (desktop + mobile) before 3b and
  Increment 4 start.**
